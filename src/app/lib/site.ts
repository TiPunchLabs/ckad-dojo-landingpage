...
export const CURRICULUM_URL = `${GITHUB_REPO}/blob/main/docs/ckad-curriculum.md`;
export const ISSUES_URL = `${GITHUB_REPO}/issues`;

/** Fallback only — the live count comes from useGithubStars. */
export const GITHUB_STARS = 87;
